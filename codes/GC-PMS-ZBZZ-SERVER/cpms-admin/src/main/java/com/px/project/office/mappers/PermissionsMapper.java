...
package com.px.project.office.mappers;

import com.px.project.office.entities.Permission;
...
@Component
@Primary
public class PermissionsMapper extends AbstractMapper<Permission, com.px.project.office.documentserver.models.filemodel.Permission> {
    @Autowired
    private ModelMapper mapper;

    public PermissionsMapper() {
        super(com.px.project.office.documentserver.models.filemodel.Permission.class);
    }

    @PostConstruct
    public void configure() {  // configure the permission mapper
        mapper.createTypeMap(Permission.class, com.px.project.office.documentserver.models.filemodel.Permission.class)  // create the type map
                .setPostConverter(modelConverter());  // and apply the post converter to it
    }

    @Override
    void handleSpecificFields(Permission source, com.px.project.office.documentserver.models.filemodel.Permission destination) {  // handle specific permission fields
